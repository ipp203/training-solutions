...
public class SocialNetworkTest {
    ...
    public void createMember() {
        Member member = new Member("John Doe", Arrays.asList("Java", "OOP"), Member.Sex.MALE);
        assertEquals("John Doe", member.getName());
        assertEquals(Arrays.asList("Java", "OOP"), member.getSkills());
        assertEquals(Member.Sex.MALE, member.getGender());
    ...
    public void testFindMembersBy() {
        SocialNetwork socialNetwork = new SocialNetwork(Arrays.asList(
                new Member("John Doe", Arrays.asList("Java", "OOP"), Member.Sex.MALE),
                new Member("Jane Doe", Arrays.asList(".NET", "OOP"), Member.Sex.FEMALE),
                new Member("James Doe", Arrays.asList("Python", "Java", "OOP"), Member.Sex.MALE),
                new Member("Janet Doe", Arrays.asList("JavaScript", "scripting"), Member.Sex.MALE)
        ));
    ...
    public void testApplyToSelectedMembers() {
        SocialNetwork socialNetwork = new SocialNetwork(Arrays.asList(
                new Member("John Doe", Arrays.asList("Java", "OOP"), Member.Sex.MALE),
                new Member("Jane Doe", Arrays.asList(".NET", "OOP", "db"), Member.Sex.FEMALE),
                new Member("James Doe", Arrays.asList("Python", "Java", "OOP"), Member.Sex.MALE),
                new Member("Janet Doe", Arrays.asList("JavaScript", "scripting", "db"), Member.Sex.FEMALE),
                new Member("Jenifer Doe", Arrays.asList("C", "C++", "ASM"), Member.Sex.FEMALE)
        ));

        socialNetwork.applyToSelectedMembers(
                m -> m.getGender() == Member.Sex.FEMALE && m.getSkills().contains("db"),
