...
public class BusTimeTableTest {
    ...
    @Test
    public void firstBusTodayTest() {
        BusTimeTable timeTable = new BusTimeTable(10, 16, 15);
        assertEquals("10:15", timeTable.firstBusToday().toString());
        timeTable.getTimeTable().add(new SimpleTime(9, 45));
        assertEquals("9:45", timeTable.firstBusToday().toString());
    }
}