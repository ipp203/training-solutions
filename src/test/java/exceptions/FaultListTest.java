...
public class FaultListTest {
    ...
    public void processing() {
        ...
        expected.add("2," + FaultList.ProcessingResult.WORD_COUNT_ERROR.getCode());
        expected.add("3," + FaultList.ProcessingResult.VALUE_ERROR.getCode());
        expected.add("5," + FaultList.ProcessingResult.DATE_ERROR.getCode());
        expected.add("6," + FaultList.ProcessingResult.VALUE_AND_DATE_ERROR.getCode());
